...
m4l_ggF_4e_13TeV = ROOT.TH1F("m4l_ggF_4e_13TeV", "m4l_ggF_4e_13TeV", 600, 130, 1500)
chain.Draw("m4l_constrained_HM>>m4l_ggF_4e_13TeV", "weight*(event_type == 1 && m4l_constrained_HM > 130 && m4l_constrained_HM < 1500)")

out = ROOT.TFile.Open("nominal_qqZZ_raw.root", 'recreate')
m4l_ggF_4e_13TeV.Write()
out.Close()
